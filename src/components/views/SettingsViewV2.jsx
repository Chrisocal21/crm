              ...
              <div className="space-y-4">
                ...
                <label className="flex items-center justify-between p-3 bg-slate-800/50 rounded-lg cursor-pointer hover:bg-slate-800 transition-colors">
                  <div>
                    ...
                    <div className="text-xs text-slate-400">Use more compact layout for lists</div>
                  </div>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              <div className="flex justify-between items-center mb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1">Manage product and service types</p>
                </div>
                <button
                  onClick={() => {
                    const newType = {
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              <div className="flex justify-between items-center mb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1">Manage materials and pricing</p>
                </div>
                <button
                  onClick={() => {
                    const newMaterial = {
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              <div className="flex justify-between items-center mb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1">Manage order add-ons</p>
                </div>
                <button
                  onClick={() => {
                    const newAddon = {
        ...
        {activeTab === 'data' && hasPermission('manageSettings') && (
          <>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              ...
              <p className="text-slate-400 text-xs mb-4">Load or clear demo data for testing</p>
