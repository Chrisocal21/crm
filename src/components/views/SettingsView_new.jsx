  ...
  return (
    <div>
      ...
      <div className="space-y-4">
          ...
          <>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-slate-300 mb-2 text-sm">Auto-Archive (days, 0=never)</label>
                  <input
                    type="number"
                    defaultValue="90"
                    className="w-full px-4 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white text-sm focus:outline-none focus:border-blue-500"
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              ...
              <p className="text-slate-400 text-xs mb-3">Connect your sales channels to sync orders</p>
              <div className="space-y-2">
                {CONFIG.stores.map(store => (
                  <label key={store.id} className="flex items-center justify-between p-3 bg-slate-800/50 rounded-lg cursor-pointer hover:bg-slate-800 transition-colors">
                    <div className="flex items-center space-x-3">
                      <img src={store.icon} alt={store.label} className="w-6 h-6" />
                      <div>
                        <div className="text-white text-sm font-medium">{store.label}</div>
          ...
          <>
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              ...
              <div className="space-y-4">
                ...
                <label className="flex items-center justify-between p-3 bg-slate-800/50 rounded-lg cursor-pointer hover:bg-slate-800 transition-colors">
                  <div>
                    <div className="text-white text-sm font-medium">Compact View</div>
                    <div className="text-xs text-slate-400">Use more compact layout for lists and tables</div>
                  </div>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              ...
              <div className="space-y-4">
                ...
                <label className="flex items-center justify-between p-3 bg-slate-800/50 rounded-lg cursor-pointer hover:bg-slate-800 transition-colors">
                  <div>
                    <div className="text-white text-sm font-medium">Auto-send Invoice Emails</div>
                    <div className="text-xs text-slate-400">Automatically email invoices to clients</div>
                  </div>
                  <input type="checkbox" className="w-4 h-4 text-blue-600 rounded" />
                </label>
                <label className="flex items-center justify-between p-3 bg-slate-800/50 rounded-lg cursor-pointer hover:bg-slate-800 transition-colors">
                  <div>
                    <div className="text-white text-sm font-medium">CC Yourself on Emails</div>
                    <div className="text-xs text-slate-400">Receive copies of emails sent to clients</div>
                  </div>
                  <input type="checkbox" defaultChecked className="w-4 h-4 text-blue-600 rounded" />
                </label>
              </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-slate-800/50">
                  <tr>
                    <th className="text-left p-3 text-slate-300 font-medium text-xs">User</th>
                    <th className="text-left p-3 text-slate-300 font-medium text-xs">Role</th>
                    <th className="text-left p-3 text-slate-300 font-medium text-xs">Status</th>
                    <th className="text-right p-3 text-slate-300 font-medium text-xs">Actions</th>
                  </tr>
                </thead>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              <div className="flex justify-between items-center mb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1">Manage available product and service types</p>
                </div>
                <button
                  onClick={() => {
                    const newType = {
                  ...
                  <div key={type.id} className="flex items-center gap-3 p-3 bg-slate-800/50 rounded-lg border border-slate-700">
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-3">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-slate-400">${type.basePrice}</span>
                        <button
                          onClick={() => {
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              <div className="flex justify-between items-center mb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1">Manage materials and their pricing</p>
                </div>
                <button
                  onClick={() => {
                    const newMaterial = {
                ...
                {(activeConfig.materials || CONFIG.materials).map((material, index) => (
                  <div key={material.id} className="flex items-center gap-3 p-3 bg-slate-800/50 rounded-lg border border-slate-700">
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-3">
                      ...
                      />
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-slate-400">+${material.priceModifier}</span>
                        <button
                          onClick={() => {
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              <div className="flex justify-between items-center mb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1">Manage available add-ons for orders</p>
                </div>
                <button
                  onClick={() => {
                    const newAddon = {
                ...
                {(activeConfig.addons || CONFIG.addons).map((addon, index) => (
                  <div key={addon.id} className="flex items-center gap-3 p-3 bg-slate-800/50 rounded-lg border border-slate-700">
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-3">
                      ...
                      />
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-slate-400">${addon.price}</span>
                        <button
                          onClick={() => {
        ...
        {/* Data Tab */}
        {activeTab === 'data' && hasPermission('manageSettings') && (
          <>
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              ...
              <div className="space-y-2">
                ...
                <button className="w-full text-left px-4 py-3 bg-slate-800 hover:bg-slate-700 rounded-lg text-white transition-colors flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-xs text-slate-400">Clear local cache and temporary data</div>
                  </div>
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                  </svg>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              ...
              <p className="text-slate-400 text-xs mb-4">Load or clear demonstration data for testing purposes</p>
              <div className="flex gap-3">
                <button
                  onClick={() => {
                    showConfirm('Load sample data? This will add demo orders, clients, inventory, and more.', () => {
                      loadSampleData()
                    })
                  }}
                  className="flex-1 px-4 py-3 bg-green-600 hover:bg-green-700 rounded-lg transition-colors flex items-center justify-center space-x-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-3 bg-red-600 hover:bg-red-700 rounded-lg transition-colors flex items-center justify-center space-x-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                  </svg>
